...
INSERT INTO tb_notification (text, moment, read, route, user_id) VALUES ('Material aceito', TIMESTAMP WITH TIME ZONE '2019-01-02T03:15:00Z', false, 'exemplo de rota', 1);
INSERT INTO tb_notification (text, moment, read, route, user_id) VALUES ('Material aceito', TIMESTAMP WITH TIME ZONE '2019-01-02T03:30:00Z', true, 'exemplo de rota', 1);
INSERT INTO tb_notification (text, moment, read, route, user_id) VALUES ('Material aceito', TIMESTAMP WITH TIME ZONE '2019-01-02T04:00:00Z', false, 'exemplo de rota', 2);
